      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden z-0">
          <motion.img 
            ...
            src="/src/assets/images/lbd_hero_afro_banner_1780280798186.png" 
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="group bg-[#FBFFFC] border border-[#E2DFD9] rounded-sm overflow-hidden flex flex-col justify-between transition-all duration-300 hover:shadow-md">
            <div className="relative aspect-[3/4] bg-[#F2EFE9] overflow-hidden">
              <img src="/src/assets/images/lbd_product_pearl_slide_1780280828278.png" alt="Amas de perles" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" />
          ...
          <div className="group bg-[#FBFFFC] border border-[#E2DFD9] rounded-sm overflow-hidden flex flex-col justify-between transition-all duration-300 hover:shadow-md">
            <div className="relative aspect-[3/4] bg-[#F2EFE9] overflow-hidden">
              <img src="/src/assets/images/lbd_product_pearl_tiara_1780280813932.png" alt="Duo de perles" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" />
              <div className="absolute top-3 left-3">
          ...
          <div className="group bg-[#FBFFFC] border border-[#E2DFD9] rounded-sm overflow-hidden flex flex-col justify-between transition-all duration-300 hover:shadow-md">
            <div className="relative aspect-[3/4] bg-[#F2EFE9] overflow-hidden">
              <img src="/src/assets/images/lbd_product_blossom_knot_1780280846869.png" alt="Nœud Fleuri" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" />
              <div className="absolute top-3 left-3">
          ...
          <div className="group bg-[#FBFFFC] border border-[#E2DFD9] rounded-sm overflow-hidden flex flex-col justify-between transition-all duration-300 hover:shadow-md">
            <div className="relative aspect-[3/4] bg-[#F2EFE9] overflow-hidden">
              <img src="/src/assets/images/lbd_product_geometric_slide_1780280862288.png" alt="Forme Géométrique" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" />
              <div className="absolute top-3 left-3">
